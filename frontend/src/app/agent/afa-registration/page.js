      ...
      <div className="card-outline rounded-3xl bg-surface-card p-6">
        ...
        <form action={initializeAfaRegistration} className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <input
            ...
            required
          />
          <button className="rounded-full bg-accent px-5 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-night md:col-span-2">
        ...
        <div className="mt-6 space-y-3">
          {registrations.length === 0 ? (
            ...
            registrations.map((item) => {
              ...
              return (
                <div key={item.id} className="rounded-2xl border border-accent/10 bg-surface-card px-4 py-4 text-sm">
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      <p className="text-xs uppercase tracking-[0.2em] text-ink-muted">Registration</p>
